...
\subsection{Step 1: Sound power level leaving a duct}
...
\subsection{Step 2: SPL in the conference room from a single ductwork}
...
\subsection{Step 3: Sum SPLs from both ducts}
...
Table~\ref{tbl:BN_conf} and Figure~\ref{fig:Lp1+2} on page~\pageref{fig:Lp1+2} present the L\textsubscript{p\textsubscript{1}} results in octave bands between 63~Hz and 4~kHz.
