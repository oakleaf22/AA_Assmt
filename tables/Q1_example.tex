\begin{sidewaystable}[htbp]
	...
	\begin{tabular}{@{}m{5cm}rm{10cm}@{}}
		...
		&  &  \\
		Attn\textsubscript{horizontal $\rightarrow$ vertical} (dB) & 4.77 & $|10 log \frac{S_{vertical}}{S_{vertical} + S_{horizontal}}|$ \\
		&  &  \\
		Attn\textsubscript{vertical} (dB) & $0.5 \times (1 + 1) = 1.00$ & Same as notes for Attn\textsubscript{horizontal} \\
		&  &  \\
