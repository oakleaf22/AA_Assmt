\begin{sidewaystable}[htbp]
	...
	\begin{tabular}{@{}m{5cm}rm{10cm}@{}}
		...
		&  &  \\
		SPL in conference room due to single ductwork, L\textsubscript{p\textsubscript{1 single}} (dB) & $29.63 - 10 log \frac{80}{0.48} + 14 = 21.45$ & \begin{tabular}[c]{@{}l@{}} $L_{p_1 single} = L_{W out} – 10 log \frac{V_1}{T_{1}} + 14$\end{tabular} \\
		&  &  \\
